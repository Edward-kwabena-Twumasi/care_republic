...
import 'package:thecut/screens/orientation/client_registration_screen.dart';
...
class _OTPReceptionScreenState extends State<OTPReceptionScreen> {
  ...
  initState() {
    ...
    sendDummyOTPMessage().then((value) {
      print("OTP Message Sent Successfully $value");
    });
                                      ...
                                      onPressed: () {
                                        ...
                                        getUserInformation(matchingAccount).then((value){
                                          ...
                                          Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) {
                                           return ClientRegistrationScreen(prevDetails: {
